...
var cgd_debug_dashboard_ui_API = $hx_exports["HDS"] = function() { };
$hxClasses["cgd.debug.dashboard.ui.API"] = cgd_debug_dashboard_ui_API;
cgd_debug_dashboard_ui_API.__name__ = "cgd.debug.dashboard.ui.API";
cgd_debug_dashboard_ui_API.updateObjectField = function(objectId,fieldName,value) {
	cgd_debug_dashboard_ui_UpdateObjectField.run(objectId,fieldName,value);
};
var cgd_debug_dashboard_ui_Main = function() { };
$hxClasses["cgd.debug.dashboard.ui.Main"] = cgd_debug_dashboard_ui_Main;
cgd_debug_dashboard_ui_Main.__name__ = "cgd.debug.dashboard.ui.Main";
cgd_debug_dashboard_ui_Main.main = function() {
	var _ = cgd_debug_dashboard_ui_API;
};
var cgd_debug_dashboard_ui_UpdateObjectField = function() { };
$hxClasses["cgd.debug.dashboard.ui.UpdateObjectField"] = cgd_debug_dashboard_ui_UpdateObjectField;
cgd_debug_dashboard_ui_UpdateObjectField.__name__ = "cgd.debug.dashboard.ui.UpdateObjectField";
cgd_debug_dashboard_ui_UpdateObjectField.run = function(objectId,fieldName,value) {
	var code = cgd_debug_dashboard_ui_UpdateObjectField.buildScript(objectId,fieldName,value);
	cgd_debug_dashboard_ui_UpdateObjectField.sendEval(code);
};
cgd_debug_dashboard_ui_UpdateObjectField.buildScript = function(objectId,fieldName,value) {
	var valueExpr = cgd_debug_dashboard_ui_UpdateObjectField.toHScriptLiteral(value);
	var sb_b = "";
	sb_b += "var o = get2d(\"";
...
cgd_debug_dashboard_ui_UpdateObjectField.toHScriptLiteral = function(v) {
...
cgd_debug_dashboard_ui_UpdateObjectField.quoteString = function(s) {
	var out_b = "";
	out_b += "\"";
	var i = 0;
	while(i < s.length) {
...
cgd_debug_dashboard_ui_UpdateObjectField.sendEval = function(code) {
...
cgd_debug_dashboard_ui_Main.main();
